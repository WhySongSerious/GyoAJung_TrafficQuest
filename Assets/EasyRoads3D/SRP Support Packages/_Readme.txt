...
URP or HDRP packages for the installed version will be auto imported. Materials that still appear in pink can be upgraded using the Unity Render Pipeline Converter tool. 
